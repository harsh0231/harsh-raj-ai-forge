        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-up">
            <p className="text-lg mb-6">
              I'm an experienced <span className="text-accent1 font-semibold">Data Scientist</span> with a passion for 
            ...
            <p className="text-lg mb-6">
              I've worked extensively with <span className="text-accent1 font-semibold">ROS2 (Humble Hawksbill)</span> on 
          ...
          <div className="grid gap-6">
            <div className="bg-card shadow-md rounded-lg p-6 animate-fade-up delay-100 card-hover">
              <div className="flex items-start gap-4">
                <div className="bg-accent1/10 p-3 rounded-md">
                  <BriefcaseBusiness className="w-6 h-6 text-accent1" />
                </div>
                <div>
            ...
            <div className="bg-card shadow-md rounded-lg p-6 animate-fade-up delay-200 card-hover">
              <div className="flex items-start gap-4">
                <div className="bg-accent2/10 p-3 rounded-md">
                  <BookOpen className="w-6 h-6 text-accent2" />
                </div>
                <div>
            ...
            <div className="bg-card shadow-md rounded-lg p-6 animate-fade-up delay-300 card-hover">
              <div className="flex items-start gap-4">
                <div className="bg-accent1/10 p-3 rounded-md">
                  <Award className="w-6 h-6 text-accent1" />
                </div>
                <div>
